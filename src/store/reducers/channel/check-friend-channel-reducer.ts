...
import { CHECK_FRIEND_CHANNEL_FAILURE, CHECK_FRIEND_CHANNEL_REQUEST, CHECK_FRIEND_CHANNEL_SUCCESS, CheckFriendChannelActionTypes } from "../../actions/channel/check-friend-channel-action";
