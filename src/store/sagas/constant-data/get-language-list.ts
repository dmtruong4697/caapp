...
import { GET_LANGUAGE_LIST_REQUEST, getLanguageListFailure, getLanguageListRequest, getLanguageListSuccess, resetLanguageListState } from '../../actions/constant-data/get-language-list';
...
function* getLanguageList(action: ReturnType<typeof getLanguageListRequest>): Generator<any, void, any> {
  try {
    ...
    yield put(resetLanguageListState());
  } catch (error: any) {
