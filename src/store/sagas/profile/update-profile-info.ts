...
import { resetUpdateProfileInfoState, UPDATE_PROFILE_INFO_REQUEST, updateProfileInfoFailure, updateProfileInfoRequest, updateProfileInfoSuccess } from '../../actions/profile/update-profile-info';
...
function* updateProfileInfo(action: ReturnType<typeof updateProfileInfoRequest>): Generator<any, void, any> {
  try {
    ...
    yield put(resetUpdateProfileInfoState());
  } catch (error: any) {
