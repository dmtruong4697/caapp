...
import { GET_FRIEND_CHANNEL_INFO_REQUEST, GET_GROUP_CHANNEL_INFO_REQUEST, getFriendChannelInfoFailure, getFriendChannelInfoRequest, getFriendChannelInfoSuccess, getGroupChannelInfoFailure, getGroupChannelInfoRequest, getGroupChannelInfoSuccess } from '../actions/channel-info-action';
